...
pub fn uuid_to_string<S>(uuid_: &uuid::Uuid, serializer: S) -> Result<S::Ok, S::Error>
where
    S: Serializer,
{
    ...
    D: Deserializer<'de>,
{
    match String::deserialize(deserializer) {
        Ok(value) => uuid::Uuid::parse_str(&value).map_err(|error| serde::de::Error::custom(error.to_string())),
