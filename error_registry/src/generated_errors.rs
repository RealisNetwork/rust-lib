...
impl From<GooglePlay> for ErrorType {
    fn from(error: GooglePlay) -> Self {
        ErrorType::Generated(error.into())
    }
}
...
impl From<Blog> for GeneratedError {
    fn from(error: Blog) -> Self {
        GeneratedError::Blog(error)
    }
}
impl From<Blog> for ErrorType {
    fn from(error: Blog) -> Self {
        ErrorType::Generated(error.into())
    }
}
...
impl From<Critical> for GeneratedError {
    fn from(error: Critical) -> Self {
        GeneratedError::Critical(error)
    }
}
impl From<Critical> for ErrorType {
    fn from(error: Critical) -> Self {
        ErrorType::Generated(error.into())
    }
}
...
impl From<GeneratedError> for u32 {
    fn from(error_type: GeneratedError) -> u32 {
        match error_type {
            ...
            GeneratedError::Analytics(analytics) => u32::from(analytics),
            GeneratedError::Common(common) => u32::from(common),
            GeneratedError::Withdraw(withdraw) => u32::from(withdraw),
...
impl From<GooglePlay> for u32 {
    fn from(error_type: GooglePlay) -> u32 {
        match error_type {
...
#[derive(Debug, Clone, Deserialize, Serialize, PartialEq, Eq)]
pub enum Analytics {
    #[serde(rename = "analytics.unknownType")]
    UnknownType,
}
impl ToString for Analytics {
    fn to_string(&self) -> String {
        match self {
            Self::UnknownType => "analytics.unknownType".to_string(),
        }
    }
}
impl From<Analytics> for u32 {
    fn from(error_type: Analytics) -> u32 {
        match error_type {
            Analytics::UnknownType => 5384227u32,
        }
    }
}
#[derive(Debug, Clone, Deserialize, Serialize, PartialEq, Eq)]
...
#[derive(Debug, Clone, Deserialize, Serialize, PartialEq, Eq)]
pub enum Withdraw {
    #[serde(rename = "withdraw.minWithdrawalAmount")]
    MinWithdrawalAmount,
    #[serde(rename = "withdraw.addressNotExist")]
    AddressNotExist,
}
impl ToString for Withdraw {
    fn to_string(&self) -> String {
        match self {
            Self::MinWithdrawalAmount => "withdraw.minWithdrawalAmount".to_string(),
            Self::AddressNotExist => "withdraw.addressNotExist".to_string(),
        }
    }
}
impl From<Withdraw> for u32 {
    fn from(error_type: Withdraw) -> u32 {
        match error_type {
            Withdraw::MinWithdrawalAmount => 10787u32,
            Withdraw::AddressNotExist => 14646u32,
        }
    }
}
#[derive(Debug, Clone, Deserialize, Serialize, PartialEq, Eq)]
...
impl From<Functions> for u32 {
    fn from(error_type: Functions) -> u32 {
        match error_type {
...
impl From<Orchestrator> for u32 {
    fn from(error_type: Orchestrator) -> u32 {
        match error_type {
...
pub enum Blog {
    ...
    UserWithoutStatus,
    #[serde(rename = "blog.userWithoutTransactions")]
    UserWithoutTransactions,
    #[serde(rename = "blog.pollHasExpired")]
    PollHasExpired,
...
impl ToString for Blog {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::UserWithoutTransactions => "blog.userWithoutTransactions".to_string(),
            Self::PollHasExpired => "blog.pollHasExpired".to_string(),
...
impl From<Blog> for u32 {
    fn from(error_type: Blog) -> u32 {
        match error_type {
            ...
            Blog::UserWithoutTransactions => 10037u32,
            Blog::PollHasExpired => 5335078u32,
...
pub enum Blockchain {
    ...
    Transaction,
    #[serde(rename = "blockchain.lockNft")]
    LockNft,
    #[serde(rename = "blockchain.transferNft")]
    TransferNft,
    ...
    AddAccessKey,
    #[serde(rename = "blockchain.transfer")]
    Transfer,
    #[serde(rename = "blockchain.unlockNft")]
    UnlockNft,
    #[serde(rename = "blockchain.burnNft")]
    BurnNft,
}
impl ToString for Blockchain {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::LockNft => "blockchain.lockNft".to_string(),
            Self::TransferNft => "blockchain.transferNft".to_string(),
            ...
            Self::Transfer => "blockchain.transfer".to_string(),
            Self::UnlockNft => "blockchain.unlockNft".to_string(),
            Self::BurnNft => "blockchain.burnNft".to_string(),
        }
    }
}
impl From<Blockchain> for u32 {
    fn from(error_type: Blockchain) -> u32 {
        match error_type {
            ...
            Blockchain::LockNft => 14390u32,
            Blockchain::TransferNft => 14136u32,
            Blockchain::NotEnoughBalance => 24100u32,
            Blockchain::CallContract => 14918u32,
            Blockchain::AddAccessKey => 14418u32,
            Blockchain::Transfer => 6469667u32,
            Blockchain::UnlockNft => 9484320u32,
            Blockchain::BurnNft => 1333285u32,
        }
    }
}
#[derive(Debug, Clone, Deserialize, Serialize, PartialEq, Eq)]
pub enum Transactions {
    ...
    UpdateBalanceRecord,
    #[serde(rename = "transactions.alreadyTLISExists")]
    AlreadyTlisExists,
    #[serde(rename = "transactions.notEnoughBalance")]
    NotEnoughBalance,
    #[serde(rename = "transactions.amountZero")]
    AmountZero,
}
impl ToString for Transactions {
    fn to_string(&self) -> String {
        match self {
            ...
            Self::AlreadyTlisExists => "transactions.alreadyTLISExists".to_string(),
            Self::NotEnoughBalance => "transactions.notEnoughBalance".to_string(),
            Self::AmountZero => "transactions.amountZero".to_string(),
        }
    }
}
impl From<Transactions> for u32 {
    fn from(error_type: Transactions) -> u32 {
        match error_type {
            Transactions::UpdateBalanceRecord => 22578u32,
            Transactions::AlreadyTlisExists => 10293u32,
            Transactions::NotEnoughBalance => 22562u32,
            Transactions::AmountZero => 32625u32,
        }
    }
}
#[derive(Debug, Clone, Deserialize, Serialize, PartialEq, Eq)]
...
pub enum Confirmation {
    ...
    UnSuccess,
    #[serde(rename = "confirmation.alreadyVoted")]
    AlreadyVoted,
...
impl ToString for Confirmation {
    fn to_string(&self) -> String {
        match self {
...
impl From<Confirmation> for u32 {
    fn from(error_type: Confirmation) -> u32 {
        match error_type {
...
impl From<Soul> for u32 {
    fn from(error_type: Soul) -> u32 {
        match error_type {
