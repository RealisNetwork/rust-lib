...
impl Schema for UserProfileGetUserByParamsParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"ethWallet\":{\"type\":\"string\"},\"GPA\":{\"type\":\"string\"},\"supportId\":{\"type\":\"string\"},\"email\":{\"type\":\"string\"},\"nickname\":{\"type\":\"string\"},\"lisWallet\":{\"type\":\"string\"}}}") . unwrap ()
    }
}
