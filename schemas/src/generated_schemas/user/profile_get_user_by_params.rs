...
impl Schema for UserProfileGetUserByParamsParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"lisWallet\":{\"type\":\"string\"},\"email\":{\"type\":\"string\"},\"nickname\":{\"type\":\"string\"},\"ethWallet\":{\"type\":\"string\"},\"supportId\":{\"type\":\"string\"},\"GPA\":{\"type\":\"string\"}},\"required\":null}")
    }
}
