...
impl Schema for UserProfileGetUserByParamsParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"GPA\":{\"type\":\"string\"},\"supportId\":{\"type\":\"string\"},\"lisWallet\":{\"type\":\"string\"},\"ethWallet\":{\"type\":\"string\"},\"nickname\":{\"type\":\"string\"},\"email\":{\"type\":\"string\"}}}") . unwrap ()
    }
}
