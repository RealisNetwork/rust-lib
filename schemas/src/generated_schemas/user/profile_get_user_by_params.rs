...
impl Schema for UserProfileGetUserByParamsParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"supportId\":{\"type\":\"string\"},\"lisWallet\":{\"type\":\"string\"},\"nickname\":{\"type\":\"string\"},\"ethWallet\":{\"type\":\"string\"},\"email\":{\"type\":\"string\"},\"GPA\":{\"type\":\"string\"}}}") . unwrap ()
    }
}
