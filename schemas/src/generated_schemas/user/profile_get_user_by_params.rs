...
impl Schema for UserProfileGetUserByParamsParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"ethWallet\":{\"type\":\"string\"},\"GPA\":{\"type\":\"string\"},\"nickname\":{\"type\":\"string\"},\"email\":{\"type\":\"string\"},\"supportId\":{\"type\":\"string\"},\"lisWallet\":{\"type\":\"string\"}}}") . unwrap ()
    }
}
