...
impl Schema for UserProfileGetUserByParamsParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"lisWallet\":{\"type\":\"string\"},\"ethWallet\":{\"type\":\"string\"},\"email\":{\"type\":\"string\"},\"nickname\":{\"type\":\"string\"},\"GPA\":{\"type\":\"string\"},\"supportId\":{\"type\":\"string\"}}}") . unwrap ()
    }
}
