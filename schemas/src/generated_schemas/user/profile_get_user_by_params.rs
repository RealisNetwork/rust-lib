...
impl Schema for UserProfileGetUserByParamsParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"lisWallet\":{\"type\":\"string\"},\"supportId\":{\"type\":\"string\"},\"GPA\":{\"type\":\"string\"},\"email\":{\"type\":\"string\"},\"nickname\":{\"type\":\"string\"},\"ethWallet\":{\"type\":\"string\"}}}") . unwrap ()
    }
}
