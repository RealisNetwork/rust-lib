...
impl Agent for SoulAdapterWalletGetUserIdByAddressParams {
    fn topic() -> &'static str {
        "soul-adapter_wallet_getUserIdByAddress"
    }
...
impl Agent for SoulAdapterWalletGetUserIdByAddressReturns {
    fn topic() -> &'static str {
        "soul-adapter_wallet_getUserIdByAddress"
    }
    fn method() -> &'static str {
