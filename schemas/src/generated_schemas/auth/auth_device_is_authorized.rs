...
impl Schema for AuthAuthDeviceIsAuthorizedParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"appId\":{\"type\":\"integer\",\"minimum\":-9223372036854775808,\"maximum\":9223372036854775807,\"additionalAttributes\":{\"numberType\":\"Number\"}},\"providerId\":{\"type\":\"string\"},\"internalUserId\":{\"type\":\"string\"}},\"required\":[\"internalUserId\",\"appId\",\"providerId\"]}")
    }
}
