...
impl Schema for AuthAuthDeviceIsAuthorizedParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"internalUserId\":{\"type\":\"string\"},\"appId\":{\"type\":\"integer\",\"minimum\":-9223372036854775808,\"maximum\":9223372036854775807,\"additionalAttributes\":{\"numberType\":\"Number\"}},\"providerId\":{\"type\":\"string\"}},\"required\":[\"internalUserId\",\"appId\",\"providerId\"]}") . unwrap ()
    }
}
