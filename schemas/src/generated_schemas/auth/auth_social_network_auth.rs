...
impl Schema for AuthAuthSocialNetworkAuthParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"provider\":{\"type\":\"string\"},\"deviceId\":{\"type\":\"string\"},\"appId\":{\"type\":\"integer\",\"minimum\":-9223372036854775808,\"maximum\":9223372036854775807,\"additionalAttributes\":{\"numberType\":\"Number\"}},\"credential\":{\"type\":\"string\"}},\"required\":[\"provider\"]}") . unwrap ()
    }
}
