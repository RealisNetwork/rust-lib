...
impl Schema for AuthAuthSocialNetworkAuthParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"credential\":{\"type\":\"string\"},\"provider\":{\"type\":\"string\"},\"appId\":{\"type\":\"integer\",\"minimum\":-9223372036854775808,\"maximum\":9223372036854775807,\"additionalAttributes\":{\"numberType\":\"Number\"}},\"deviceId\":{\"type\":\"string\"}},\"required\":[\"provider\"]}") . unwrap ()
    }
}
