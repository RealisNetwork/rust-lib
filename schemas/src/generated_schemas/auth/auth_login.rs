...
impl Schema for AuthAuthLoginParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"deviceId\":{\"type\":\"string\"},\"username\":{\"type\":\"string\"},\"appId\":{\"type\":\"integer\",\"minimum\":-2147483648,\"maximum\":2147483647,\"additionalAttributes\":{\"numberType\":\"Int\"}},\"password\":{\"type\":\"string\"}},\"required\":[\"username\",\"password\"]}") . unwrap ()
    }
}
