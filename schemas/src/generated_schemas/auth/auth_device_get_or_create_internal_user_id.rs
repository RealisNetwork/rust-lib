...
impl Schema for AuthAuthDeviceGetOrCreateInternalUserIdParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"appId\":{\"type\":\"integer\",\"minimum\":-2147483648,\"maximum\":2147483647,\"additionalAttributes\":{\"numberType\":\"Int\"}},\"provider\":{},\"email\":{\"type\":\"string\"},\"providerId\":{\"type\":\"string\"}},\"required\":[\"providerId\",\"provider\"]}")
    }
}
