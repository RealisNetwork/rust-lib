...
impl Schema for AuthAuthGetUserInfoByTokenReturns {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"userId\":{\"type\":\"string\"},\"roles\":{\"type\":\"array\",\"items\":{\"type\":\"string\"}},\"isBanned\":{\"type\":\"boolean\"},\"email\":{\"type\":\"string\"},\"username\":{\"type\":\"string\"},\"id\":{\"type\":\"string\"},\"emailVerified\":{\"type\":\"boolean\"}},\"required\":[\"id\",\"username\",\"emailVerified\",\"email\",\"roles\",\"isBanned\",\"userId\"]}")
    }
}
