...
pub use dragocats_battle_process_endpoints_get_test_state::*;
pub use dragocats_battle_process_endpoints_start_test::*;
pub use dragocats_battle_process_endpoints_stop_test::*;
