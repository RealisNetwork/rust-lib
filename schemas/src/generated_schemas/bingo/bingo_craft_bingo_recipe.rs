...
impl Schema for BingoBingoCraftBingoRecipeReturns {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"jackpotRewardAmount\":{\"type\":\"string\"},\"hardRewardAmount\":{\"type\":\"string\"},\"bingoReceiptId\":{\"type\":\"integer\",\"minimum\":-2147483648,\"maximum\":2147483647,\"additionalAttributes\":{\"numberType\":\"Int\"}}},\"required\":[\"bingoReceiptId\",\"hardRewardAmount\",\"jackpotRewardAmount\"]}")
    }
}
