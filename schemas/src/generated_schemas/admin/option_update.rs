...
impl Schema for AdminOptionUpdateParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"description\":{\"type\":\"string\"},\"extraDetails\":{\"type\":\"object\",\"properties\":{\"type\":{\"type\":\"string\"},\"tab\":{\"type\":\"string\"}},\"required\":null},\"value\":{\"type\":\"string\"},\"clientKey\":{\"type\":\"string\"}},\"required\":[\"clientKey\"]}")
    }
}
