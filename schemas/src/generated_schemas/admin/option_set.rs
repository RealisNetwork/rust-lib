...
impl Schema for AdminOptionSetParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"value\":{\"type\":\"string\"},\"extraDetails\":{\"type\":\"object\",\"properties\":{\"tab\":{\"type\":\"string\"},\"type\":{\"type\":\"string\"}},\"required\":null},\"clientKey\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"}},\"required\":[\"clientKey\",\"value\"]}")
    }
}
