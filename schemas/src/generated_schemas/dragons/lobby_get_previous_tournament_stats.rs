...
impl Agent for DragonsLobbyGetPreviousTournamentStatsParams {
    fn topic() -> &'static str {
        "dragons_lobby_getPreviousTournamentStats"
    }
...
impl Agent for DragonsLobbyGetPreviousTournamentStatsReturns {
    fn topic() -> &'static str {
        "dragons_lobby_getPreviousTournamentStats"
    }
    fn method() -> &'static str {
