...
pub struct LobbyStatsOptionsEndpointsGetByPersonalTypeReturns {
    ...
    pub multipliers_ranges:
        LobbyStatsOptionsEndpointsGetByPersonalTypeReturnsMultipliersRangesParams,
