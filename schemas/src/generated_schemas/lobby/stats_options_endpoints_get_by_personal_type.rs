...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LobbyStatsOptionsEndpointsGetByPersonalTypeReturnsLevelUpOptionsParams { # [serde (rename = "baseScrollsCount")] pub base_scrolls_count : i64 , # [serde (rename = "experienceCoefficients")] pub experience_coefficients : Vec < LobbyStatsOptionsEndpointsGetByPersonalTypeReturnsLevelUpOptionsParamsExperienceCoefficientsParamsParams > , # [serde (rename = "strength")] pub strength : i64 , # [serde (rename = "intelligence")] pub intelligence : i64 , # [serde (rename = "scrollsByLevels")] pub scrolls_by_levels : Vec < LobbyStatsOptionsEndpointsGetByPersonalTypeReturnsLevelUpOptionsParamsScrollsByLevelsParamsParams > , # [serde (rename = "attributesPerLevel")] pub attributes_per_level : LobbyStatsOptionsEndpointsGetByPersonalTypeReturnsLevelUpOptionsParamsAttributesPerLevelParams , # [serde (rename = "agility")] pub agility : i64 , # [serde (rename = "baseExperience")] pub base_experience : i64 , # [serde (rename = "maxLevel")] pub max_level : i64 , # [serde (rename = "experience")] pub experience : i64 }
#[derive(Debug, Clone, Serialize, Deserialize)]
