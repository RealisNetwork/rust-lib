...
#[derive(Debug, Serialize, Deserialize)]
pub struct LobbyStatsOptionsEndpointsCreateOrUpdateParamsLevelUpOptionsParams { # [serde (rename = "experienceCoefficients")] pub experience_coefficients : Vec < LobbyStatsOptionsEndpointsCreateOrUpdateParamsLevelUpOptionsParamsExperienceCoefficientsParamsParams > , # [serde (rename = "experience")] pub experience : i64 , # [serde (rename = "baseExperience")] pub base_experience : i64 , # [serde (rename = "scrollsByLevels")] pub scrolls_by_levels : Vec < LobbyStatsOptionsEndpointsCreateOrUpdateParamsLevelUpOptionsParamsScrollsByLevelsParamsParams > , # [serde (rename = "agility")] pub agility : i64 , # [serde (rename = "attributesPerLevel")] pub attributes_per_level : LobbyStatsOptionsEndpointsCreateOrUpdateParamsLevelUpOptionsParamsAttributesPerLevelParams , # [serde (rename = "intelligence")] pub intelligence : i64 , # [serde (rename = "baseScrollsCount")] pub base_scrolls_count : i64 , # [serde (rename = "strength")] pub strength : i64 , # [serde (rename = "maxLevel")] pub max_level : i64 }
#[derive(Debug, Serialize, Deserialize)]
...
pub struct LobbyStatsOptionsEndpointsCreateOrUpdateParams {
    ...
    pub level_up_options: LobbyStatsOptionsEndpointsCreateOrUpdateParamsLevelUpOptionsParams,
    #[serde(rename = "mainCharacteristic")]
    pub main_characteristic: String,
    #[serde(rename = "multipliersRanges")]
    pub multipliers_ranges: LobbyStatsOptionsEndpointsCreateOrUpdateParamsMultipliersRangesParams,
    #[serde(rename = "attributesRanges")]
    pub attributes_ranges: LobbyStatsOptionsEndpointsCreateOrUpdateParamsAttributesRangesParams,
}
