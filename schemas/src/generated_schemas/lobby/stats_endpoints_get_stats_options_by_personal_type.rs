...
#[derive(Debug, Serialize, Deserialize)]
pub struct LobbyStatsEndpointsGetStatsOptionsByPersonalTypeReturnsLevelUpOptionsParams { # [serde (rename = "attributesPerLevel")] pub attributes_per_level : LobbyStatsEndpointsGetStatsOptionsByPersonalTypeReturnsLevelUpOptionsParamsAttributesPerLevelParams , # [serde (rename = "experience")] pub experience : i32 , # [serde (rename = "baseExperience")] pub base_experience : i32 , # [serde (rename = "experienceCoefficients")] pub experience_coefficients : Vec < LobbyStatsEndpointsGetStatsOptionsByPersonalTypeReturnsLevelUpOptionsParamsExperienceCoefficientsParamsParams > , # [serde (rename = "baseScrollsCount")] pub base_scrolls_count : i32 , # [serde (rename = "scrollsByLevels")] pub scrolls_by_levels : Vec < LobbyStatsEndpointsGetStatsOptionsByPersonalTypeReturnsLevelUpOptionsParamsScrollsByLevelsParamsParams > , # [serde (rename = "strength")] pub strength : String , # [serde (rename = "maxLevel")] pub max_level : i32 , # [serde (rename = "intelligence")] pub intelligence : String , # [serde (rename = "agility")] pub agility : String }
#[derive(Debug, Serialize, Deserialize)]
