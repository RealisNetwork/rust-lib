...
pub struct NearAdapterContractCallTransferParams {
    ...
    pub amount: String,
    #[serde(rename = "receiverId", deserialize_with = "deserialize_to_string")]
    pub receiver_id: String,
}
impl Schema for NearAdapterContractCallTransferParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"userId\":{\"type\":\"string\"},\"amount\":{\"type\":\"string\"},\"receiverId\":{\"type\":\"string\"}},\"required\":[\"receiverId\",\"amount\"]}") . unwrap ()
    }
}
