...
impl Schema for NotificationsNotificationsCreateNewParams {
    fn schema() -> Value {
        serde_json :: from_str ("{\"type\":\"object\",\"properties\":{\"notificationType\":{},\"senderUserId\":{\"type\":\"string\"},\"category\":{\"type\":\"string\"},\"title\":{\"type\":\"string\"},\"userId\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"}},\"required\":[\"notificationType\",\"userId\",\"category\",\"description\",\"senderUserId\",\"title\"]}") . unwrap ()
    }
}
