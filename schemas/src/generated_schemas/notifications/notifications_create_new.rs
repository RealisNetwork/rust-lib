...
impl Schema for NotificationsNotificationsCreateNewParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"description\":{\"type\":\"string\"},\"senderUserId\":{\"type\":\"string\"},\"title\":{\"type\":\"string\"},\"notificationType\":{},\"userId\":{\"type\":\"string\"},\"category\":{\"type\":\"string\"}},\"required\":[\"notificationType\",\"userId\",\"category\",\"description\",\"senderUserId\",\"title\"]}")
    }
}
