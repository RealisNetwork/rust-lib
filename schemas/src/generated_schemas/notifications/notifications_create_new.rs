...
impl Schema for NotificationsNotificationsCreateNewParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"title\":{\"type\":\"string\"},\"userId\":{\"type\":\"string\"},\"notificationType\":{},\"description\":{\"type\":\"string\"},\"category\":{\"type\":\"string\"},\"senderUserId\":{\"type\":\"string\"}},\"required\":[\"notificationType\",\"userId\",\"category\",\"description\",\"senderUserId\",\"title\"]}")
    }
}
