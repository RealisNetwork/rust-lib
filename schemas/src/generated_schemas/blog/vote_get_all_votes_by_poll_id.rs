...
pub struct BlogVoteGetAllVotesByPollIdParams {
    #[serde(rename = "id")]
    pub id: f64,
}
impl Schema for BlogVoteGetAllVotesByPollIdParams {
    fn schema() -> Value {
...
impl Agent for BlogVoteGetAllVotesByPollIdParams {
    fn topic() -> &'static str {
        "blog_vote_getAllVotesByPollId"
    }
    fn method() -> &'static str {
        "vote_getAllVotesByPollId"
    }
    fn agent() -> &'static str {
        "blog"
    }
