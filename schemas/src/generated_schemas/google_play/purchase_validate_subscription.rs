...
impl Schema for GooglePlayPurchaseValidateSubscriptionParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"subscriptionProductId\":{\"type\":\"string\"},\"packageName\":{\"type\":\"string\"},\"subscriptionToken\":{\"type\":\"string\"}},\"required\":[\"subscriptionToken\",\"subscriptionProductId\",\"packageName\"]}")
    }
}
