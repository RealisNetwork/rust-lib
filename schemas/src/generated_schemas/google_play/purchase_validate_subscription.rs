...
impl Schema for GooglePlayPurchaseValidateSubscriptionParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"subscriptionToken\":{\"type\":\"string\"},\"subscriptionProductId\":{\"type\":\"string\"},\"packageName\":{\"type\":\"string\"}},\"required\":[\"subscriptionToken\",\"subscriptionProductId\",\"packageName\"]}")
    }
}
