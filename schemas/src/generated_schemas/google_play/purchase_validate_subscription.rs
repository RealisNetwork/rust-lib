...
impl Schema for GooglePlayPurchaseValidateSubscriptionParams {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"subscriptionToken\":{\"type\":\"string\"},\"packageName\":{\"type\":\"string\"},\"subscriptionProductId\":{\"type\":\"string\"}},\"required\":[\"subscriptionToken\",\"subscriptionProductId\",\"packageName\"]}")
    }
}
#[derive(Debug, Clone, Serialize, Deserialize)]
