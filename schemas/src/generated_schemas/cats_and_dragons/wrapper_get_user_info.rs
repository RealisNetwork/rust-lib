...
impl Schema for CatsAndDragonsWrapperGetUserInfoReturns {
    fn schema() -> Value {
        serde_json :: json ! ("{\"type\":\"object\",\"properties\":{\"nickname\":{\"type\":\"string\"},\"hasReferrer\":{\"type\":\"boolean\"},\"isNewProfile\":{\"type\":\"boolean\"},\"refLink\":{\"type\":\"string\"},\"email\":{\"type\":\"string\"},\"refCode\":{\"type\":\"string\"},\"isAuthorized\":{\"type\":\"boolean\"}},\"required\":[\"email\",\"isAuthorized\",\"refLink\",\"refCode\",\"hasReferrer\",\"nickname\",\"isNewProfile\"]}")
    }
}
