...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DragocatsStorageInventoryEndpointsAddUnitNotificationReturns { # [serde (rename = "status")] pub status : i32 , # [serde (rename = "combatPower")] pub combat_power : i32 , # [serde (rename = "experienceForLevelup")] pub experience_for_levelup : i32 , # [serde (rename = "isNft")] pub is_nft : bool , # [serde (rename = "unitCharacteristicDto")] pub unit_characteristic_dto : Vec < DragocatsStorageInventoryEndpointsAddUnitNotificationReturnsUnitCharacteristicDtoParamsParams > , # [serde (rename = "parts")] pub parts : DragocatsStorageInventoryEndpointsAddUnitNotificationReturnsPartsParams , # [serde (rename = "bindingId")] pub binding_id : i32 , # [serde (rename = "rarity")] pub rarity : i32 , # [serde (rename = "maxLevel")] pub max_level : i32 , # [serde (rename = "experience")] pub experience : i32 , # [serde (rename = "unitType")] pub unit_type : String , # [serde (rename = "level")] pub level : i32 }
