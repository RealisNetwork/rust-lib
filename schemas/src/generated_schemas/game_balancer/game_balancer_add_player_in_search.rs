...
pub struct GameBalancerGameBalancerAddPlayerInSearchParams {
    #[serde(rename = "region", deserialize_with = "deserialize_to_string")]
    pub region: String,
    #[serde(rename = "stats")]
    pub stats: GameBalancerGameBalancerAddPlayerInSearchParamsStatsParams,
    #[serde(rename = "heroType", deserialize_with = "deserialize_to_string")]
