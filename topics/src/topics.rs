/// This file is autogenerated, all changes you will write here will be lost
/// In case you want to add some topics, use custom.rs file
/// In case all the topics here are in one line, make cargo fmt or build with
/// make build
...
pub const ADMIN_OPTION_UPDATE_ALL_TOPIC: &'static str = "admin_option_updateAll";
pub const ADMIN_OPTION_GET_ALL_BY_FILTER_TOPIC: &'static str = "admin_option_getAllByFilter";
pub const ADMIN_OPTION_UPDATE_TOPIC: &'static str = "admin_option_update";
...
pub const ADMIN_USER_ROLE_GET_ALL_USERS_WITH_NICKNAME_TOPIC: &'static str = "admin_userRole_getAllUsersWithNickname";
...
pub const AUTH_AUTH_DEVICE_GET_OR_CREATE_INTERNAL_USER_ID_TOPIC: &'static str = "auth_authDevice_getOrCreateInternalUserId";
pub const AUTH_AUTH_DEVICE_UPDATE_INTERNAL_ID_BY_DEVICE_ID_TOPIC: &'static str = "auth_authDevice_updateInternalIdByDeviceId";
pub const AUTH_AUTH_DEVICE_GET_CLIENT_INFO_TOPIC: &'static str = "auth_authDevice_getClientInfo";
pub const AUTH_AUTH_DEVICE_ASSIGN_INTERNAL_ID_TO_PROVIDER_ID_TOPIC: &'static str = "auth_authDevice_assignInternalIdToProviderId";
pub const AUTH_AUTH_DEVICE_UPDATE_PROVIDER_STATUS_BY_PROVIDER_ID_TOPIC: &'static str =
    "auth_authDevice_updateProviderStatusByProviderId";
pub const AUTH_AUTH_DEVICE_UPDATE_PROVIDER_STATUS_BY_INTERNAL_USER_ID_TOPIC: &'static str =
    "auth_authDevice_updateProviderStatusByInternalUserId";
pub const AUTH_AUTH_DEVICE_GET_PROVIDER_BY_INTERNAL_USER_ID_TOPIC: &'static str = "auth_authDevice_getProviderByInternalUserId";
pub const AUTH_AUTH_DEVICE_GET_CLIENT_STATUS_BY_INTERNAL_USER_ID_TOPIC: &'static str =
    "auth_authDevice_getClientStatusByInternalUserId";
pub const AUTH_AUTH_DEVICE_LOGOUT_DEVICE_BY_KEYCLOAK_ID_TOPIC: &'static str = "auth_authDevice_logoutDeviceByKeycloakId";
pub const AUTH_AUTH_DEVICE_GET_DEVICE_ID_BY_INTERNAL_ID_TOPIC: &'static str = "auth_authDevice_getDeviceIdByInternalId";
pub const AUTH_AUTH_DEVICE_IS_NEW_CLIENT_TOPIC: &'static str = "auth_authDevice_isNewClient";
pub const AUTH_AUTH_DEVICE_IS_AUTHORIZED_TOPIC: &'static str = "auth_authDevice_isAuthorized";
pub const AUTH_AUTH_DEVICE_GET_LOGIN_DEVICE_BY_USER_ID_TOPIC: &'static str = "auth_authDevice_getLoginDeviceByUserId";
pub const AUTH_AUTH_DEVICE_LOGOUT_ALL_DEVICES_TOPIC: &'static str = "auth_authDevice_logoutAllDevices";
pub const AUTH_AUTH_DEVICE_DELETE_ACCOUNT_TOPIC: &'static str = "auth_authDevice_deleteAccount";
pub const AUTH_AUTH_DEVICE_GET_KEYCLOAK_PROVIDER_ID_BY_USER_ID_TOPIC: &'static str = "auth_authDevice_getKeycloakProviderIdByUserId";
pub const AUTH_AUTH_DEVICE_IS_NEW_CLIENT_IN_APP_TOPIC: &'static str = "auth_authDevice_isNewClientInApp";
...
pub const BALANCES_BALANCES_GET_SOFT_CURRENCY_BALANCE_TOPIC: &'static str = "balances_balances_getSoftCurrencyBalance";
pub const BALANCES_BALANCES_INCREASE_SOFT_CURRENCY_TOPIC: &'static str = "balances_balances_increaseSoftCurrency";
pub const BALANCES_BALANCES_DECREASE_SOFT_CURRENCY_TOPIC: &'static str = "balances_balances_decreaseSoftCurrency";
pub const BALANCES_BALANCES_ADD_FREE_EXPERIENCE_TOPIC: &'static str = "balances_balances_addFreeExperience";
pub const BALANCES_BALANCES_USE_FREE_EXPERIENCE_TOPIC: &'static str = "balances_balances_useFreeExperience";
pub const BALANCES_BALANCES_GET_BALANCES_BY_USER_ID_TOPIC: &'static str = "balances_balances_getBalancesByUserId";
pub const BALANCES_BALANCES_GET_FREE_EXPERIENCE_BALANCE_TOPIC: &'static str = "balances_balances_getFreeExperienceBalance";
pub const BALANCES_BALANCES_FREE_EXPERIENCE_ADDED_NOTIFICATION_TOPIC: &'static str =
    "balances_balances_freeExperienceAddedNotification";
pub const BATTLE_PASS_BATTLE_PASS_ENDPOINTS_RECEIVE_REWARD_TOPIC: &'static str = "battle-pass_battlePassEndpoints_receiveReward";
pub const BATTLE_PASS_BATTLE_PASS_ENDPOINTS_GET_BATTLE_PASS_DATA_TOPIC: &'static str =
    "battle-pass_battlePassEndpoints_getBattlePassData";
pub const BATTLE_PASS_BATTLE_PASS_ENDPOINTS_GET_CURRENT_BATTLE_PASS_EXPERIENCE_TOPIC: &'static str =
    "battle-pass_battlePassEndpoints_getCurrentBattlePassExperience";
pub const BATTLE_PASS_BATTLE_PASS_ENDPOINTS_GET_BATTLE_PASS_SEASON_INFO_TOPIC: &'static str =
    "battle-pass_battlePassEndpoints_getBattlePassSeasonInfo";
pub const BATTLE_PASS_BATTLE_PASS_ENDPOINTS_GET_BATTLE_PASS_PRICES_TOPIC: &'static str =
    "battle-pass_battlePassEndpoints_getBattlePassPrices";
pub const BATTLE_PASS_BATTLE_PASS_ENDPOINTS_RECEIVE_OLD_BATTLE_PASS_REWARDS_TOPIC: &'static str =
    "battle-pass_battlePassEndpoints_receiveOldBattlePassRewards";
pub const BATTLE_PASS_BATTLE_PASS_ENDPOINTS_PURCHASE_BATTLE_PASS_EXPERIENCE_TO_LEVELUP_TOPIC: &'static str =
    "battle-pass_battlePassEndpoints_purchaseBattlePassExperienceToLevelup";
pub const BATTLE_PASS_BATTLE_PASS_ENDPOINTS_PURCHASE_BATTLE_PASS_PREMIUM_TOPIC: &'static str =
...
pub const BINANCE_WALLET_WALLET_GET_ADDRESS_BY_USER_ID_TOPIC: &'static str = "binance-wallet_wallet_getAddressByUserId";
pub const BINANCE_WALLET_WALLET_GET_USER_ID_BY_ADDRESS_TOPIC: &'static str = "binance-wallet_wallet_getUserIdByAddress";
pub const BLOG_BLOG_CREATE_TOPIC: &'static str = "blog_blog_create";
pub const BLOG_BLOG_UPDATE_TOPIC: &'static str = "blog_blog_update";
pub const BLOG_BLOG_DELETE_TOPIC: &'static str = "blog_blog_delete";
pub const BLOG_BLOG_GET_ALL_TOPIC: &'static str = "blog_blog_getAll";
pub const BLOG_BLOG_GET_TOPIC: &'static str = "blog_blog_get";
pub const BLOG_BLOG_GET_BY_URL_TOPIC: &'static str = "blog_blog_getByUrl";
pub const BLOG_BLOG_GET_PINNED_TOPIC: &'static str = "blog_blog_getPinned";
pub const BLOG_BLOG_GET_ALL_BY_FILTER_TOPIC: &'static str = "blog_blog_getAllByFilter";
pub const BLOG_BLOG_GET_ALL_WITH_CATEGORY_LIST_TOPIC: &'static str = "blog_blog_getAllWithCategoryList";
pub const BLOG_CATEGORY_CREATE_TOPIC: &'static str = "blog_category_create";
pub const BLOG_CATEGORY_UPDATE_TOPIC: &'static str = "blog_category_update";
pub const BLOG_CATEGORY_DELETE_TOPIC: &'static str = "blog_category_delete";
pub const BLOG_CATEGORY_GET_ALL_TOPIC: &'static str = "blog_category_getAll";
pub const BLOG_CATEGORY_GET_TOPIC: &'static str = "blog_category_get";
...
pub const DRAGOCATS_STORAGE_UNIT_ENDPOINTS_GET_BY_UNIT_ID_TOPIC: &'static str = "dragocats-storage_unitEndpoints_getByUnitId";
...
pub const GAME_BALANCER_GAME_BALANCER_CHECK_IN_NOTIFICATION_TOPIC: &'static str = "gameBalancer_gameBalancer_checkInNotification";
pub const GOOGLE_PLAY_PURCHASE_VALIDATE_SUBSCRIPTION_TOPIC: &'static str = "google-play_purchase_validateSubscription";
pub const LISTERIA_STORAGE_HEROES_ENDPOINTS_STATS_UPDATED_NOTIFICATION_TOPIC: &'static str =
    "listeria-storage_heroesEndpoints_statsUpdatedNotification";
pub const LISTERIA_STORAGE_HEROES_ENDPOINTS_GET_HEROES_LIST_BY_USER_ID_TOPIC: &'static str =
    "listeria-storage_heroesEndpoints_getHeroesListByUserId";
pub const LISTERIA_STORAGE_HEROES_ENDPOINTS_GIVE_FREE_EXPERIENCE_TO_HERO_TOPIC: &'static str =
    "listeria-storage_heroesEndpoints_giveFreeExperienceToHero";
pub const LISTERIA_STORAGE_HEROES_ENDPOINTS_HERO_ADDED_NOTIFICATION_TOPIC: &'static str =
    "listeria-storage_heroesEndpoints_heroAddedNotification";
pub const LISTERIA_STORAGE_HEROES_ENDPOINTS_LEVEL_UP_TOPIC: &'static str = "listeria-storage_heroesEndpoints_levelUp";
pub const LISTERIA_STORAGE_HEROES_ENDPOINTS_GET_BY_ID_TOPIC: &'static str = "listeria-storage_heroesEndpoints_getById";
pub const LISTERIA_STORAGE_INVENTORY_ENDPOINTS_GET_LOOTBOXES_LIST_TOPIC: &'static str =
    "listeria-storage_inventoryEndpoints_getLootboxesList";
pub const LISTERIA_STORAGE_INVENTORY_ENDPOINTS_OPEN_LOOTBOX_TOPIC: &'static str = "listeria-storage_inventoryEndpoints_openLootbox";
pub const LISTERIA_STORAGE_INVENTORY_ENDPOINTS_GET_ITEMS_LIST_TOPIC: &'static str = "listeria-storage_inventoryEndpoints_getItemsList";
pub const LISTERIA_STORAGE_INVENTORY_ENDPOINTS_GET_HERO_SCROLLS_COUNT_TOPIC: &'static str =
    "listeria-storage_inventoryEndpoints_getHeroScrollsCount";
pub const LISTERIA_STORAGE_INVENTORY_ENDPOINTS_GET_EQUIPMENT_SCROLLS_COUNT_TOPIC: &'static str =
    "listeria-storage_inventoryEndpoints_getEquipmentScrollsCount";
pub const LISTERIA_STORAGE_INVENTORY_ENDPOINTS_ADDED_UNEQUIPPABLE_ITEM_NOTIFICATION_TOPIC: &'static str =
    "listeria-storage_inventoryEndpoints_addedUnequippableItemNotification";
pub const LISTERIA_STORAGE_INVENTORY_ENDPOINTS_GET_BY_ID_TOPIC: &'static str = "listeria-storage_inventoryEndpoints_getById";
pub const LISTERIA_STORAGE_INVENTORY_ENDPOINTS_LEVEL_UP_TOPIC: &'static str = "listeria-storage_inventoryEndpoints_levelUp";
pub const LOBBY_EQUIPMENT_ENDPOINTS_GET_ITEM_BY_ITEM_ID_AND_USER_ID_TOPIC: &'static str =
    "lobby_equipmentEndpoints_getItemByItemIdAndUserId";
pub const LOBBY_EQUIPMENT_ENDPOINTS_EQUIP_ITEM_TOPIC: &'static str = "lobby_equipmentEndpoints_equipItem";
pub const LOBBY_EQUIPMENT_ENDPOINTS_UNEQUIP_ITEM_TOPIC: &'static str = "lobby_equipmentEndpoints_unequipItem";
pub const LOBBY_EQUIPMENT_ENDPOINTS_ADDED_ITEM_NOTIFICATION_TOPIC: &'static str = "lobby_equipmentEndpoints_addedItemNotification";
pub const LOBBY_EQUIPMENT_ENDPOINTS_UPDATED_ITEM_NOTIFICATION_TOPIC: &'static str = "lobby_equipmentEndpoints_updatedItemNotification";
pub const LOBBY_HEROES_ENDPOINTS_GET_EQUIPPED_ITEMS_TOPIC: &'static str = "lobby_heroesEndpoints_getEquippedItems";
pub const LOBBY_HEROES_ENDPOINTS_GET_ACTIVE_HERO_ID_TOPIC: &'static str = "lobby_heroesEndpoints_getActiveHeroId";
pub const LOBBY_HEROES_ENDPOINTS_EQUIP_HERO_TOPIC: &'static str = "lobby_heroesEndpoints_equipHero";
pub const LOBBY_HEROES_ENDPOINTS_GET_HERO_DTO_ATTRIBUTES_TOPIC: &'static str = "lobby_heroesEndpoints_getHeroDTOAttributes";
pub const LOBBY_HEROES_ENDPOINTS_GET_HEROES_LIST_TOPIC: &'static str = "lobby_heroesEndpoints_getHeroesList";
pub const LOBBY_HEROES_ENDPOINTS_HERO_ADDED_NOTIFICATION_TOPIC: &'static str = "lobby_heroesEndpoints_heroAddedNotification";
...
pub const LOBBY_STATS_ENDPOINTS_GET_LEVEL_UP_OPTIONS_BY_PERSONAL_TYPE_TOPIC: &'static str =
...
pub const MARKET_ITEMS_GET_LOOTBOXES_LIST_TOPIC: &'static str = "market_items_getLootboxesList";
pub const MARKET_PLACE_MARKET_PLACE_GET_BOUGHT_ITEMS_TOPIC: &'static str = "market-place_marketPlace_getBoughtItems";
pub const MARKET_PLACE_MARKET_PLACE_GET_ITEMS_BY_FILTER_TOPIC: &'static str = "market-place_marketPlace_getItemsByFilter";
pub const MARKET_PLACE_MARKET_PLACE_LOCK_ITEM_TOPIC: &'static str = "market-place_marketPlace_lockItem";
pub const MARKET_PLACE_MARKET_PLACE_CANCEL_SALE_TOPIC: &'static str = "market-place_marketPlace_cancelSale";
pub const MARKET_PLACE_MARKET_PLACE_GET_CANCELED_ITEMS_TOPIC: &'static str = "market-place_marketPlace_getCanceledItems";
pub const MARKET_PLACE_MARKET_PLACE_ADD_TO_MARKET_PLACE_TOPIC: &'static str = "market-place_marketPlace_addToMarketPlace";
pub const NOTIFICATIONS_NOTIFICATIONS_CREATE_NEW_TOPIC: &'static str = "notifications_notifications_createNew";
pub const ORCHESTRATOR_BALANCE_INCREASE_USER_BALANCE_TOPIC: &'static str = "orchestrator_balance_increaseUserBalance";
pub const ORCHESTRATOR_BATTLE_PASS_PURCHASE_PREMIUM_TOPIC: &'static str = "orchestrator_battlePass_purchasePremium";
pub const ORCHESTRATOR_BATTLE_PASS_PURCHASE_EXPERIENCE_TOPIC: &'static str = "orchestrator_battlePass_purchaseExperience";
pub const ORCHESTRATOR_BATTLE_PASS_GENERATE_PRODUCT_TOPIC: &'static str = "orchestrator_battlePass_generateProduct";
pub const ORCHESTRATOR_LOOTBOX_OPEN_TOPIC: &'static str = "orchestrator_lootbox_open";
pub const ORCHESTRATOR_LOOTBOX_PURCHASE_TOPIC: &'static str = "orchestrator_lootbox_purchase";
pub const ORCHESTRATOR_PRODUCT_BURN_TOPIC: &'static str = "orchestrator_product_burn";
pub const ORCHESTRATOR_PURCHASE_PURCHASE_PRODUCT_TOPIC: &'static str = "orchestrator_purchase_purchaseProduct";
pub const ORCHESTRATOR_WALLET_GET_MY_TOPIC: &'static str = "orchestrator_wallet_getMy";
pub const ORCHESTRATOR_WALLET_GET_BY_USER_ID_TOPIC: &'static str = "orchestrator_wallet_getByUserId";
pub const PRODUCT_FACTORY_GENERATOR_GENERATE_TOPIC: &'static str = "product-factory_generator_generate";
pub const PRODUCT_FACTORY_LOOTBOX_OPEN_TOPIC: &'static str = "product-factory_lootbox_open";
pub const PRODUCT_FACTORY_PRODUCTS_GET_INFO_BY_PRODUCT_ID_TOPIC: &'static str = "product-factory_products_getInfoByProductId";
pub const PRODUCT_FACTORY_LOOTBOX_TYPE_ADD_TOPIC: &'static str = "productFactory_lootboxType_add";
pub const PRODUCT_FACTORY_LOOTBOX_TYPE_GET_ALL_TOPIC: &'static str = "productFactory_lootboxType_getAll";
pub const PRODUCT_FACTORY_LOOTBOX_TYPE_UPDATE_BY_LOOTBOX_ID_TOPIC: &'static str = "productFactory_lootboxType_updateByLootboxId";
pub const PRODUCT_FACTORY_LOOTBOX_TYPE_GET_BY_LOOTBOX_ID_TOPIC: &'static str = "productFactory_lootboxType_getByLootboxId";
pub const PRODUCT_FACTORY_PRODUCT_MARK_HERO_AS_NFT_TOPIC: &'static str = "productFactory_product_markHeroAsNFT";
pub const PRODUCT_FACTORY_PRODUCT_ADD_LOOTBOX_TOPIC: &'static str = "productFactory_product_addLootbox";
pub const PRODUCT_FACTORY_PRODUCT_LOOTBOX_OPENED_NOTIFICATION_TOPIC: &'static str = "productFactory_product_lootboxOpenedNotification";
...
pub const PURCHASE_PRODUCT_PURCHASE_LOOTBOX_TOPIC: &'static str = "purchase_product_purchaseLootbox";
...
pub const PURCHASE_WALLET_GET_WALLET_BY_USER_ID_TOPIC: &'static str = "purchase_wallet_getWalletByUserId";
pub const REALIS_WALLET_MANAGER_GET_MY_ADDRESS_TOPIC: &'static str = "realis_walletManager_getMyAddress";
pub const REFERRAL_LINK_GET_TOPIC: &'static str = "referral_link_get";
pub const REFERRAL_LINK_GET_MY_TOPIC: &'static str = "referral_link_getMy";
pub const REFERRAL_LINK_GET_ALL_TOPIC: &'static str = "referral_link_getAll";
pub const REFERRAL_LINK_GET_ALL_MY_TOPIC: &'static str = "referral_link_getAllMy";
pub const REFERRAL_REFERRAL_GET_REFERRAL_INFO_LIST_TOPIC: &'static str = "referral_referral_getReferralInfoList";
pub const REFERRAL_REFERRAL_ADD_REFERRAL_TOPIC: &'static str = "referral_referral_addReferral";
...
pub const STATUS_CONFIG_ADD_TOPIC: &'static str = "status_config_add";
pub const STATUS_CONFIG_DELETE_TOPIC: &'static str = "status_config_delete";
pub const STATUS_CONFIG_DISABLE_TOPIC: &'static str = "status_config_disable";
...
pub const STATUS_CONFIG_GET_ALL_TOPIC: &'static str = "status_config_getAll";
pub const STATUS_CONFIG_GET_MEMBERSHIP_INFO_TOPIC: &'static str = "status_config_getMembershipInfo";
pub const STATUS_CONFIG_UPDATE_PRIORITY_INDEX_TOPIC: &'static str = "status_config_updatePriorityIndex";
pub const STATUS_MEMBERSHIP_UPDATE_TOPIC: &'static str = "status_membership_update";
pub const STATUS_MEMBERSHIP_ADD_AWARD_MEMBERSHIP_TOPIC: &'static str = "status_membership_addAwardMembership";
pub const STATUS_MEMBERSHIP_GET_INFO_TOPIC: &'static str = "status_membership_getInfo";
pub const STATUS_MEMBERSHIP_CHANGE_MEMBERSHIP_GAME_TOPIC: &'static str = "status_membership_changeMembershipGame";
pub const STATUS_MEMBERSHIP_DISABLE_TOPIC: &'static str = "status_membership_disable";
pub const STATUS_MEMBERSHIP_GET_ALL_ACTIVE_TOPIC: &'static str = "status_membership_getAllActive";
...
pub const TRANSACTIONS_BALANCE_UPDATE_TRANSACTION_DATA_FROM_BLOCKCHAIN_TOPIC: &'static str =
...
pub const TRANSACTIONS_REGISTRY_PRODUCT_BURN_PRODUCT_TOPIC: &'static str = "transactions_registryProduct_burnProduct";
