...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct GameBalancerGameBalancerCheckInNotificationReturnsObject40 {
...
pub struct GameBalancerGameBalancerCheckInNotificationReturnsObject4 {
    ...
    pub attributes: GameBalancerGameBalancerCheckInNotificationReturnsObject40,
...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject13 {
...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject15 {
    #[serde(rename = "vampirismPower")]
    pub vampirism_power: String,
    #[serde(rename = "agility")]
    pub agility: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject17 {
    #[serde(rename = "vampirismPower")]
    pub vampirism_power: String,
    #[serde(rename = "intelligence")]
    pub intelligence: String,
...
pub struct ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject1 {
    ...
    pub max_level: i16,
    #[serde(rename = "slots")]
    pub slots: Vec<ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject13>,
    #[serde(rename = "active")]
    pub active: bool,
    #[serde(rename = "attributes")]
    pub attributes: ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject15,
    #[serde(rename = "isPending")]
    pub is_pending: bool,
    #[serde(rename = "equipmentAttributes")]
    pub equipment_attributes: ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject17,
    #[serde(rename = "level")]
    pub level: i16,
...
pub struct ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject {
    ...
    pub to_next_level_scrolls: i32,
    #[serde(rename = "slots")]
    pub slots: Vec<ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject4>,
    #[serde(rename = "attributes")]
    pub attributes: ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject5,
    #[serde(rename = "level")]
    pub level: i16,
    #[serde(rename = "isPending")]
    pub is_pending: bool,
...
pub struct ListeriaStorageHeroesEndpointsHeroAddedNotificationReturnsObject {
    ...
    pub is_pending: bool,
    #[serde(rename = "attributes")]
    pub attributes: ListeriaStorageHeroesEndpointsHeroAddedNotificationReturnsObject13,
    #[serde(rename = "equipmentAttributes")]
...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct ListeriaStorageInventoryEndpointsGetItemsListReturnsObject6 {
    #[serde(rename = "power")]
    pub power: String,
...
pub struct ListeriaStorageInventoryEndpointsGetItemsListReturnsObject {
    ...
    pub effects: Vec<ListeriaStorageInventoryEndpointsGetItemsListReturnsObject6>,
...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct LobbyEquipmentEndpointsUpdatedItemNotificationReturnsObject3 {
    #[serde(rename = "statName")]
    pub stat_name: i8,
    #[serde(rename = "power")]
    pub power: String,
...
pub struct LobbyEquipmentEndpointsUpdatedItemNotificationReturnsObject {
    ...
    pub binding_id: i32,
    #[serde(rename = "effects")]
    pub effects: Vec<LobbyEquipmentEndpointsUpdatedItemNotificationReturnsObject3>,
    #[serde(rename = "transactionHash")]
    pub transaction_hash: Option<String>,
    #[serde(rename = "linkToExplorer")]
    pub link_to_explorer: String,
...
pub struct LobbyHeroesEndpointsHeroAddedNotificationReturnsObject {
    ...
    pub experience: i32,
    #[serde(rename = "slots")]
    pub slots: Vec<LobbyHeroesEndpointsHeroAddedNotificationReturnsObject4>,
    #[serde(rename = "toNextLevelExperience")]
    pub to_next_level_experience: i32,
    #[serde(rename = "isPending")]
    pub is_pending: bool,
...
pub struct LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject {
    ...
    pub scrolls_by_levels: Vec<LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject1>,
    #[serde(rename = "attributesPerLevel")]
    pub attributes_per_level: LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject2,
