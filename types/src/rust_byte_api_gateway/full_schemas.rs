...
pub struct ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject0 {
    ...
    pub hero_id: i8,
    #[serde(rename = "slots")]
    pub slots: Vec<ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject011>,
...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject3 {
    #[serde(rename = "healthRegenPercent")]
    pub health_regen_percent: String,
    #[serde(rename = "agility")]
    pub agility: String,
...
pub struct ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject {
    ...
    pub hero_id: i8,
    #[serde(rename = "attributes")]
    pub attributes: ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject3,
    #[serde(rename = "blockId")]
    pub block_id: Option<String>,
    #[serde(rename = "isPending")]
    pub is_pending: bool,
...
pub struct ListeriaStorageHeroesEndpointsHeroAddedNotificationReturnsObject {
    ...
    pub experience: i32,
    #[serde(rename = "attributes")]
    pub attributes: ListeriaStorageHeroesEndpointsHeroAddedNotificationReturnsObject8,
    #[serde(rename = "toNextLevelScrolls")]
    pub to_next_level_scrolls: i32,
    #[serde(rename = "level")]
    pub level: i16,
    ...
    #[serde(rename = "slots")]
    pub slots: Vec<ListeriaStorageHeroesEndpointsHeroAddedNotificationReturnsObject14>,
    #[serde(rename = "active")]
    pub active: bool,
}
#[derive(Debug, Serialize, Deserialize)]
...
pub struct LobbyHeroesEndpointsHeroAddedNotificationReturnsObject {
    ...
    pub transaction_hash: Option<String>,
    #[serde(rename = "equipmentAttributes")]
    pub equipment_attributes: LobbyHeroesEndpointsHeroAddedNotificationReturnsObject15,
}
#[derive(Debug, Serialize, Deserialize)]
#[serde(untagged)]
...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject9 {
    #[serde(rename = "level")]
    pub level: i32,
...
pub struct LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject {
    ...
    pub attributes_per_level: LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject6,
    #[serde(rename = "baseExperience")]
    pub base_experience: i32,
    #[serde(rename = "agility")]
    pub agility: String,
    #[serde(rename = "scrollsByLevels")]
    pub scrolls_by_levels: Vec<LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject9>,
}
#[derive(Debug, Serialize, Deserialize)]
#[serde(untagged)]
