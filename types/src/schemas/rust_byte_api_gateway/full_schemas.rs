...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject02 {
    #[serde(rename = "ultPower")]
    pub ult_power: String,
    #[serde(rename = "strength")]
    pub strength: String,
...
pub struct ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject0 {
    ...
    pub experience: i32,
    #[serde(rename = "attributes")]
    pub attributes: ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject02,
    #[serde(rename = "heroId")]
    pub hero_id: i8,
...
pub struct ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject {
    ...
    pub experience: i32,
    #[serde(rename = "equipmentAttributes")]
    pub equipment_attributes: ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject1,
    #[serde(rename = "attributes")]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ListeriaStorageInventoryEndpointsGetItemsListReturnsObject4 {
...
pub struct ListeriaStorageInventoryEndpointsGetItemsListReturnsObject {
    ...
    pub effects: Vec<ListeriaStorageInventoryEndpointsGetItemsListReturnsObject4>,
    #[serde(rename = "blockId")]
    pub block_id: Option<String>,
    #[serde(rename = "maxLevel")]
    pub max_level: i16,
...
pub struct LobbyHeroesEndpointsHeroAddedNotificationReturnsObject {
    ...
    pub active: bool,
    #[serde(rename = "attributes")]
    pub attributes: LobbyHeroesEndpointsHeroAddedNotificationReturnsObject5,
    #[serde(rename = "status")]
    pub status: i32,
    #[serde(rename = "level")]
    pub level: i16,
...
pub struct LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject {
    ...
    pub experience_coefficients: Vec<LobbyStatsEndpointsGetLevelUpOptionsByPersonalTypeReturnsObject0>,
    #[serde(rename = "strength")]
    pub strength: String,
