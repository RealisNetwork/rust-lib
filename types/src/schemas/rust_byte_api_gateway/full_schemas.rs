...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct GameBalancerGameBalancerCheckInNotificationReturnsObject31 {
...
pub struct GameBalancerGameBalancerCheckInNotificationReturnsObject3 {
    ...
    pub attributes: GameBalancerGameBalancerCheckInNotificationReturnsObject31,
...
pub struct ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject1 {
    ...
    pub equipment_attributes: ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject14,
    #[serde(rename = "attributes")]
    pub attributes: ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject15,
    #[serde(rename = "active")]
    pub active: bool,
    #[serde(rename = "slots")]
    pub slots: Vec<ListeriaStorageHeroesEndpointsStatsUpdatedNotificationReturnsObject17>,
...
pub struct ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject {
    ...
    pub block_id: Option<String>,
    #[serde(rename = "slots")]
    pub slots: Vec<ListeriaStorageHeroesEndpointsGetHeroesListByUserIdReturnsObject9>,
    #[serde(rename = "experience")]
    pub experience: i32,
    #[serde(rename = "status")]
    pub status: i32,
...
#[derive(Debug, Clone, Serialize, Deserialize, ByteSerialize, ByteDeserialize)]
pub struct LobbyEquipmentEndpointsAddedItemNotificationReturnsObject0 {
    #[serde(rename = "power")]
    pub power: String,
    #[serde(rename = "statName")]
    pub stat_name: i8,
...
pub struct LobbyEquipmentEndpointsAddedItemNotificationReturnsObject {
    #[serde(rename = "effects")]
    pub effects: Vec<LobbyEquipmentEndpointsAddedItemNotificationReturnsObject0>,
    #[serde(rename = "equipmentItemId")]
    pub equipment_item_id: i32,
    #[serde(rename = "blockId")]
    pub block_id: Option<String>,
...
pub struct LobbyHeroesEndpointsHeroAddedNotificationReturnsObject {
    ...
    pub max_level: i16,
    #[serde(rename = "attributes")]
    pub attributes: LobbyHeroesEndpointsHeroAddedNotificationReturnsObject3,
    #[serde(rename = "bindingId")]
    pub binding_id: i32,
    #[serde(rename = "isPending")]
    pub is_pending: bool,
    #[serde(rename = "equipmentAttributes")]
    pub equipment_attributes: LobbyHeroesEndpointsHeroAddedNotificationReturnsObject6,
    #[serde(rename = "status")]
    pub status: i32,
    #[serde(rename = "blockId")]
    pub block_id: Option<String>,
    ...
    pub active: bool,
    #[serde(rename = "slots")]
    pub slots: Vec<LobbyHeroesEndpointsHeroAddedNotificationReturnsObject15>,
}
#[derive(Debug, Serialize, Deserialize)]
#[serde(untagged)]
